export const siteConfig = {
  ...
  hero: {
    ...
    description:
      "I build software, tools, and games with a focus on clean systems, practical user experiences, and interactive applications. My work spans Unity gameplay programming, C# tools, web interfaces, multiplayer systems, XR experiences, and full project prototypes.",
    primaryAction: {
      label: "View Projects",
      to: "/projects",
    },
